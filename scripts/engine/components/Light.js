...
class PointLight extends Light{
  ...
  prepShadowMap() {
    Renderer.shaderList[Renderer.SHADOW_SHADER].setUniform("uP_Matrix", PointLight.prototype.shadowMatrix, UniformTypes.mat4);
    Renderer.shaderList[Renderer.SHADOW_SHADER_ANIM].setUniform("uP_Matrix", PointLight.prototype.shadowMatrix, UniformTypes.mat4);
  }
...
PointLight.prototype.shadowMatrix = mat4.perspective(mat4.create(), Math.PI/2, 1, 0.25, 25);
